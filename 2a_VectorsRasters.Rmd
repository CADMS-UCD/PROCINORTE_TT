...
**Exercise - Making your own map:** Get a map from the region you were born (or if you prefer where you currently live). For this, use the `getData()` function with the ISO code for your country. Use the level of resolution 2, then filter your map to show only the administration level 1 from the location selected. 
