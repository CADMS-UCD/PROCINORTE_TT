...
**Making your own map:** Get a map from the region you were born (or if you prefer where you currently live). For this:
  ...
  1. Use the `getData()` function with the ISO code for your country. Use the level of resolution 2, 
  2. Filter your map to show only the administration level 1 from the location selected. 
  3. Add a title with the name of the location and feel free to change the color of the map to your liking. 
